...
export default function App() {
  ...
  function GetLiveClock() {
    ...
    return (
      <Text>
        {dtaClock.getUTCDate()}/{dtaClock.getUTCMonth()}/
        {dtaClock.getFullYear()} - {dtaClock.getHours()}:{dtaClock.getMinutes()}
        :{dtaClock.getSeconds()}
      </Text>
    );
  }
    ...
    if (blnEntradaSaida) {
      ...
      console.log(
        "Entrada: " +
          dtaClock.getUTCDate() +
          "/" +
          dtaClock.getUTCMonth() +
          "/" +
          dtaClock.getFullYear() +
          "-" +
          dtaClock.getHours() +
          ":" +
          dtaClock.getMinutes() +
      ...
      setEntradaSaida(false); // Proxima interação será de saída.
    } else {
      lstPontos.push({ id: numLastIdPonto, tipo: "Saída", datahora: dtaClock });
      console.log(
        "Saida: " +
          +dtaClock.getUTCDate() +
          "/" +
      ...
      setEntradaSaida(true); // Proxima interação será de entrada.
    }
  ...
  return (
    <View style={styles.container}>
      ...
      <Button onPress={RegistrarPonto} title="Registrar ponto" />
